                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Kode Mata Kuliah </th><td> {{ $matakuliah->kode_mata_kuliah }} </td></tr><tr><th> Nama Mata Kuliah </th><td> {{ $matakuliah->nama_mata_kuliah }} </td></tr><tr><th> SKS </th><td> {{ $matakuliah->sks }} </td></tr>
                                </tbody>
                            </table>
                        </div>
